    ...
    <!-- makes hamburger-->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#">Home</a></li>
                <li><a href="https://twitter.com/expomuseum/">Official Twitter</a></li>
                <li><a href="https://www.facebook.com/Expo2015Milano">Official Facebook</a></li>
                <li><a href="https://instagram.com/expomuseum">Official Instagram</a></li>
...
<iframe src="http://www.rociosevillad.com/project-4/project-4FAILED/insta.html"  style="border:0px #000000 solid;" name="instaFrame" scrolling="yes" frameborder="0" height="500px" width="400px"></iframe>
  ...
  <!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script> <!-- necessary for map to work-->
           ...
           <!-- Twitter-->
            ...
            <div class="row">
                ...
                <br>
                     <p> Use the map to search for nearby places</p>
                     <br>
...
<div id="map-canvas"></div>
    ...
    <script src="js/bootstrap.min.js"></script>
        ...
        <footer>
            <h1> Thanks for staying in tune!</h1>
            
            <h2>Project created by Rocio Sevilla for Steven King's JOMC586 Course, April 2016.</h2>
        </footer>
   </html>
